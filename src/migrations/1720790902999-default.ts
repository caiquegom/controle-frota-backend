...
export class Default1720790902999 implements MigrationInterface {
    name = 'Default1720790902999'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "deliveries" ("id" SERIAL NOT NULL, "value" double precision NOT NULL, "tax" double precision NOT NULL, "totalValue" double precision NOT NULL, "isValuable" boolean NOT NULL, "isDangerous" boolean NOT NULL, "hasInsurance" boolean NOT NULL, "deliveryDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "destinyId" integer NOT NULL, "truckId" integer NOT NULL, "driverId" integer NOT NULL, "cargoId" integer NOT NULL, CONSTRAINT "REL_42a724f286341ea40a7f980cb0" UNIQUE ("cargoId"), CONSTRAINT "PK_a6ef225c5c5f0974e503bfb731f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "trucks" ("id" SERIAL NOT NULL, "plate" character varying NOT NULL, "brand" character varying NOT NULL, "model" character varying NOT NULL, "year" character varying(4) NOT NULL, "capacity" double precision NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_43b4c59e7939442f60013292443" UNIQUE ("plate"), CONSTRAINT "PK_6a134fb7caa4fb476d8a6e035f9" PRIMARY KEY ("id"))`);
